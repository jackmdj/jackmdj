...
**Drone Detection** ([drone_detector](https://github.com/jackmdj/drone_detector)). A YOLOv11 model trained on thermal imagery to detect drones, humans, and vehicles in low-visibility conditions, built with real-time airspace monitoring in mind.

**Customer Behavior Prediction** ([business-ml-demo](https://github.com/jackmdj/business-ml-demo)). Random forest models that predict when to email a customer and which product to promote, built as a full pipeline from data generation through tuning and inference.

**UCSB coursework**. [Mushroom edibility classification](https://github.com/jackmdj/mushroom_classification) in R, [US population forecasting](https://github.com/jackmdj/us_pop_time_series) with time series models, and [a study of world happiness](https://github.com/jackmdj/world_happiness_report) before and after COVID-19.
